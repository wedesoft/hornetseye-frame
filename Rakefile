...
SUMMARY = %q{Colourspace conversions and compression}
DESCRIPTION = %q{This Ruby extension provides conversions for compressed colourspaces.}
LICENSE = 'GPL-3+'
